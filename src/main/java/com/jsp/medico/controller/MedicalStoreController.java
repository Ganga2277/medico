...
import com.jsp.medico.service.MedicalStoreService;
...
public class MedicalStoreController {
	...
	@Autowired
	public MedicalStoreService service;
	...
	@GetMapping
	public ResponseEntity<ResponseStructure<MedicalStoreDto>> findMedicalStoreById
	(@RequestParam int storeId){
		return service.getMedicalStoreById(storeId);	
	}
	
	@DeleteMapping
	public ResponseEntity<ResponseStructure<MedicalStoreDto>> deleteMedicalStore
	(@RequestParam int storeId){
